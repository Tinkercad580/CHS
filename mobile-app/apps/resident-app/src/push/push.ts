...
async function ensureChannels() {
  ...
  // Required here, not imported: expo-notifications starts a push-token listener as it loads, which on web only logs a warning.
  // eslint-disable-next-line @typescript-eslint/no-require-imports
...
/** On sign-out: stop pushes to this phone for this account, and drop the token so the next account gets a fresh one. */
