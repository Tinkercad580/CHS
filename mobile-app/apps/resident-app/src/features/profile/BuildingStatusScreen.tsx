      ...
      <ScreenScroll>
        ...
        <View style={{ gap: 10 }}>
          {state.utilities.map((u) => {
            ...
            return (
              <View key={u.id} style={{ borderWidth: 1, borderColor: colors.border, borderLeftWidth: 3, borderLeftColor: edge, borderRadius: 15, backgroundColor: colors.surface, padding: 15 }}>
