      ...
      <ScreenScroll>
          ...
          <>
            ...
            <View style={{ gap: 10, marginBottom: 22 }}>
              {myBookings.map((b) => {
                ...
                return (
                  <View key={b.id} style={{ borderWidth: 1, borderColor: colors.accent200, borderRadius: 15, backgroundColor: colors.accentWash, padding: 15 }}>
        ...
        <View style={{ gap: 10 }}>
          {state.amenities.map((a) => (
            <Pressable key={a.id} onPress={() => actions.openAmenity(a.id)} style={{ borderWidth: 1, borderColor: colors.border, borderRadius: 16, backgroundColor: colors.surface, padding: 15, flexDirection: "row", alignItems: "center", gap: 13 }}>
