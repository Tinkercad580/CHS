 ...
 * without it the screen is a dead end. It sits inline, to the left of the title, with
 * the same 40px control and 12px gap ScreenHeader uses, so a back control is in the
 * same place on every screen that has one. The title block keeps the design's type
 * and spacing either way.
 */
