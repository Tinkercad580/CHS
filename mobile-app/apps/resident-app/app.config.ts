 ...
 */
const ANDROID_PACKAGE = process.env.CHS_RESIDENT_ANDROID_PACKAGE ?? "in.sahaj.resident";
const IOS_BUNDLE_ID = process.env.CHS_RESIDENT_IOS_BUNDLE_ID ?? "in.sahaj.resident";
...
export default ({ config }: ConfigContext): ExpoConfig => ({
  ...
  slug: config.slug ?? "sahaj-resident-app",
  ios: {
    ...config.ios,
