  ...
  return (
    <BottomSheet onDismissScrim={actions.closeParcel}>
      ...
      <View style={{ marginTop: 20, marginBottom: 10 }}>
        <GateButton label="Save and notify resident" onPress={() => actions.saveParcel(state.parcelUnit, state.courier)} />
      </View>
      <GateButton label="Cancel" variant="outline" height={48} onPress={actions.closeParcel} />
    </BottomSheet>
  );
}
